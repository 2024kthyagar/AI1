...
public class StringMethods
{
   public static void main(String[] args)
   {
      ...
      int pos20 = s.lastIndexOf(s2, 6);		// -1
      ...
      */     
      ...
      String[] changeDate = dateStr.split("/");
      dateStr = changeDate[1] + "-" + changeDate[0] + "-" + changeDate[2].substring(2);
      ...
      */
      String lineText = "Hello my name is Karthik and I have not eaten 84 tacos at once.";
      ...
      */      
      ...
      {
         if(Character.isLetterOrDigit(str2.charAt(i)) || (str2.charAt(i) == ' '))
